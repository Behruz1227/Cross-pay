export const TranslateRu = {
  ...
  enterTheTermenalFilialCode: 'Введите МФО терминала',
  ...
  enterYourFilialCode: 'Введите ваш МФО',
  ...
  passwordWarn:
    'Если вы хотите сохранить старый пароль, оставьте это поле пустым!',
  payment: 'Платеж',
  phone: 'Номер телефона',
  phoneError:
    'Номер телефона должен содержать ровно 9 символов и состоять только из цифр.',
  ...
  fullNameOrder: 'Имя фамилия',
  amountOrder: 'Сумма',
  mfoOrder: 'МФО',
  createdAtOrder: 'Дата создания',
