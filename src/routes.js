...
export const generateRoutes = (wordsListData) => [
  ...
  },
  {
    ...
    path: '/request',
    icon: (
      <Icon as={FaCodePullRequest} width="20px" height="20px" color="inherit" />
    ),
    component: <Request />,
  },
  {
...

  {
    ...
    path: '/words',
    icon: (
      <Icon as={RiFileList3Line} width="20px" height="20px" color="inherit" />
    ),
    component: <WordsPage />,
  },
  // {
  ...
  },
  {
    ...
    path: '/terminal',
    icon: (
      <Icon as={TbCashRegister} width="20px" height="20px" color="inherit" />
    ),
    component: <SellerTerminal />,
  },
  {
